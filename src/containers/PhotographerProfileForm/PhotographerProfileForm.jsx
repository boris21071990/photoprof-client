...
const PhotographerProfileForm = ({ photographer }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <S.Row>
        <Input ref={register} defaultValue={lastName} name="last_name" fullWidth type="text" placeholder="Last name" />
      </S.Row>
      ...
      <S.Row>
        <Textarea name="description" ref={register} fullWidth placeholder="Last name" defaultValue={description} />
      </S.Row>
      <S.Row>
